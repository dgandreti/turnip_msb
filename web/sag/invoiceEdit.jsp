                                    ...
                                    <s:if test="invoiceVTOClass.status=='Approved' || invoiceVTOClass.status=='Rejected'|| invoiceVTOClass.status=='Paid'">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <s:textfield id="invoiceYear" name="invoiceVTOClass.invoiceyear" value="%{invoiceVTOClass.invoiceyear}" cssClass=" form-control "  onkeypress="return invoceYear(event)"/>
                                            </div>
                                            <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-3">
                                                ...
                                                <s:textfield id="" name="invoiceVTOClass.totalHrs" value="%{invoiceVTOClass.totalHrs}" cssClass=" form-control " maxLength="15" />
                                            </div>
                                            <s:hidden id="usrId" name="usrId" value="%{usrId}"/>
                                            <div class="col-lg-3">
                                                <label class="labelStylereq" style="color:#56a5ec">Total Amount</label>
                                                <s:textfield id="totalAmt" name="invoiceVTOClass.totalAmt" value="%{invoiceVTOClass.totalAmt}" cssClass=" form-control " maxLength="11" />
                                            </div>
                                            <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-12">
                                            <s:if test="(invoiceVTOClass.status=='Approved' && #session.typeOfUsr!='VC' )||invoiceVTOClass.status=='Paid'">
                                                <div class="col-lg-3">
                                                    ...
                                                    <s:select id="" name="invoiceVTOClass.payType" value="%{invoiceVTOClass.payType}" cssClass="SelectBoxStyles form-control"  list="#@java.util.LinkedHashMap@{'CH':'Cheque','FT':'Funds Transfer'}"/>
                                                </div>
                                                <s:if test="#session.typeOfUsr=='VC'">
                                                    <div class="col-lg-3">
                                                ...
                                                <s:else>
                                                    <div class="col-lg-3">
                                                        <label class="labelStylereq" style="color:#56a5ec">Payment Trns.No.</label>
                                                        <s:textfield id="transNO" name="invoiceVTOClass.cheOrTransno" value="%{invoiceVTOClass.cheOrTransno}" cssClass=" form-control" maxLength="15"/>
                                                    </div>
                                                </s:else>
                                                <s:if test="#session.typeOfUsr=='VC' ">
                                                    <div class="col-lg-3">
                                                        <label class="labelStylereq" style="color:#56a5ec">Paid Amount.</label>
                                                        <s:textfield id="paidAmt" name="" value="%{invoiceVTOClass.paidAmt}"  cssClass=" form-control "  disabled="true" maxLength="11"/>
                                                    </div></s:if>
                                                <s:else>
                                                    <div class="col-lg-3">
                                                        <label class="labelStylereq" style="color:#56a5ec">Paid Amount.</label>
                                                        <s:textfield id="paidAmt" name="invoiceVTOClass.paidAmt" value="%{invoiceVTOClass.paidAmt}"  cssClass=" form-control" onblur="getBalanceAmt()" maxLength="11"/>
                                                    </div>  
                                                </s:else>
                                                <div class="col-lg-3">
                                                    <label class="labelStylereq" style="color:#56a5ec">Balance Amount</label>
                                                    <s:textfield id="balanceAmt" name="invoiceVTOClass.balanceAmt" value="%{invoiceVTOClass.balanceAmt}" cssClass=" form-control " readonly="true" maxLength="11"/>
                                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <s:if test="invoiceVTOClass.status!='Paid' ">
                                                ...
                                                <s:if test="(invoiceVTOClass.status=='Created' && #session.typeOfUsr=='VC') || invoiceVTOClass.status=='Rejected' || invoiceVTOClass.status=='Submitted' ">
                                                    <s:submit type="button"  cssStyle="margin:5px 0px;" value="" cssClass="add_searchButton form-control"><i class="fa fa-floppy-o"></i>&nbsp;Save</s:submit>
                                                </s:if>
                                                <s:elseif test="#session.typeOfUsr!='VC'">
                                                 
                                                    <s:submit type="button"  value="Paid" cssClass="add_searchButton form-control"  onclick="return getBalanceAmt();"/>
                                                </s:elseif>
                                            </s:if>
