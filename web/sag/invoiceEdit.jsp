...
<html>
    <head>
        ...
        <title>ServicesBay :: Invoice Edit</title>
        ...
        <div id="hoursOverlay_popup" class="hoursOverlay" style="width:35%">
            <div id="hoursInfoBox" >
                ...
                <div style="background-color: #3BB9FF ">
                    <table>
                        <tr><td style=""><h4>
                                    <font color="#ffffff">&nbsp;Working&nbsp;Hours&nbsp;Per&nbsp;Day&nbsp; </font>

                                </h4></td>
                        <span class=" pull-right"><h5><a href="" class="hoursOverlay_popup_close" onclick="closeEmpOverlay()"><img src="<s:url value="/includes/images/close_button.jpg"/>" height="25" width="25" ></a>&nbsp;</h5></span>
                    </table>
                </div>
                                ...
                                <div class="col-sm-12">
                                    <s:if test="invoiceVTOClass.status=='Approved' || invoiceVTOClass.status=='Rejected'|| invoiceVTOClass.status=='Paid'">
                                        ...
                                        <s:else>
                                            ...
                                            <s:textfield id="" name="" value="%{invoiceVTOClass.userName}" cssClass=" form-control " tabindex="1" disabled="true" />
                                        </div>
                                        <s:if test="invoiceVTOClass.status=='Approved' || invoiceVTOClass.status=='Rejected' || invoiceVTOClass.status=='Paid'">
                                            <div class="col-sm-3">
                                            </s:if>
                                            <s:else>
                                                ...
                                                <s:textfield id="" name="" value="%{invoiceVTOClass.custName}" cssClass=" form-control " tabindex="2"  disabled="true"/>
                                            </div>
                                            <s:if test="invoiceVTOClass.status=='Approved' || invoiceVTOClass.status=='Rejected' || invoiceVTOClass.status=='Paid'">
                                                <div class="col-sm-3">
                                                    ...
                                                    <s:textfield id="" name="" tabindex="5" value="%{invoiceVTOClass.custApprName}" cssClass=" form-control "  disabled="true"/>
                                                </div>
                                                <div class="col-sm-3">
                                                    <s:if test="invoiceVTOClass.status!='Rejected'">
                                                    ...
                                                    <s:textfield id="" name="" tabindex="8" value="%{invoiceVTOClass.custApprDate}" cssClass=" form-control "  disabled="true"/>
                                                </div>
                                            </s:if>
                                        </div>
                                        <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-3">
                                                ...
                                                <s:textfield id="" tabindex="17" name="invoiceVTOClass.totalHrs" value="%{invoiceVTOClass.totalHrs}" cssClass=" form-control " maxLength="15" />
                                            </div>
                                            <s:hidden id="usrId" name="usrId" value="%{usrId}"/>
                                            <div class="col-sm-3">
                                                <label class="labelStylereq" style="color:#56a5ec">Total Amount</label>
                                                <s:textfield id="totalAmt" tabindex="18" name="invoiceVTOClass.totalAmt" value="%{invoiceVTOClass.totalAmt}" cssClass=" form-control " maxLength="11" />
                                            </div>
                                            <div class="col-sm-3">
                                                ...
                                                <s:if test="#session.typeOfUsr=='VC' ">
                                                    <s:if test="invoiceVTOClass.status!='Submitted'">
                                                        <div class="col-sm-3">
                                                            ...
                                                            <s:textfield id="" name="" tabindex="20" value="%{invoiceVTOClass.paymentDate}"  cssClass=" form-control "  disabled="true"/>
                                                        </div>
                                                    </s:if>
                                                </s:if>
                                                <s:else>
                                        ...
                                        <div class="col-sm-12">
                                            <s:if test="(invoiceVTOClass.status=='Approved' && #session.typeOfUsr!='VC' )||invoiceVTOClass.status=='Paid'">
                                                <div class="col-sm-3">
                                                    ...
                                                    <s:select id="" tabindex="22" name="invoiceVTOClass.payType" value="%{invoiceVTOClass.payType}" cssClass="SelectBoxStyles form-control"  list="#@java.util.LinkedHashMap@{'CH':'Cheque','FT':'Funds Transfer'}"/>
                                                </div>
                                                <s:if test="#session.typeOfUsr=='VC'">
                                                    <div class="col-sm-3">
                                                        <label class="labelStylereq" style="color:#56a5ec">Payment Trns.No.</label>
                                                        <s:textfield id="" tabindex="23" name="" placeholder="Payment Trns.No." value="%{invoiceVTOClass.cheOrTransno}" cssClass=" form-control "  disabled="true"/>
                                                    </div>
                                                </s:if>
                                                <s:else>
                                                    <div class="col-sm-3">
                                                ...
                                                <s:else>
                                                    <div class="col-sm-3">
                                                        <label class="labelStylereq" style="color:#56a5ec">Paid Amount.</label>
                                                        <s:textfield id="paidAmt" tabindex="24" name="invoiceVTOClass.paidAmt" value="%{invoiceVTOClass.paidAmt}"  cssClass=" form-control" onblur="getBalanceAmt()" maxLength="11"/>
                                                    </div>  
                                                </s:else>
                                                <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="col-sm-12">
                                                ...
                                                <s:textarea id="" tabindex="26" name="invoiceVTOClass.description" maxLength="200" placeholder="Description" value="%{invoiceVTOClass.description}" cssClass=" form-control"  />
                                            </div>
                                            ...
                                            <div class="col-sm-2">
                                                <s:if test="invoiceVTOClass.status!='Paid' ">
                                                    ...
                                                    <s:if test="(invoiceVTOClass.status=='Created' && #session.typeOfUsr=='VC') || invoiceVTOClass.status=='Rejected' || invoiceVTOClass.status=='Submitted' ">
                                                        <s:submit type="button" tabindex="27" cssStyle="margin:5px 0px;" value="" cssClass="add_searchButton form-control"><i class="fa fa-floppy-o"></i>&nbsp;Save</s:submit>
                                                    </s:if>
                                                    <s:elseif test="#session.typeOfUsr!='VC'">

                                                        <s:submit type="button" tabindex="28" value="Paid" cssClass="add_searchButton form-control"  onclick="return getBalanceAmt();"/>
                                                    </s:elseif>
                                                </s:if>
