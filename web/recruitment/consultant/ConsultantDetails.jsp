                ...
                <div class="row">
                    ...
                    <div class="col-md-10 col-md-offset-0" style="background-color:#fff">
                        ...
                        <s:if test="consultFlag=='vendor'">
                            ...
                            <span class="pull-right" style="padding: 19px"><s:a href='%{#myUrl}'><img src="<s:url value="/includes/images/repeat.png"/>" height="25" width="25"></s:a></span>
                            </s:if>
                                    ...
                                    <form action="updateConsultantDetails" id="consultantForm" theme="simple">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <span class="required">
                                                ...
                                                <s:textfield cssClass="form-control dateImage" name="consult_dob" value="%{consultantVTO.consult_dob}" required="true" id="consult_dob" onkeypress="return consultantDateRepository(this)" />
                                            </span>
                                            <label class="labelStylereq" >Alternate Email:</label>
                                            <s:textfield cssClass="form-control" name="consult_alterEmail" value="%{consultantVTO.consult_alterEmail}" id="consult_alterEmail" placeholder="Alternate Email Id" onblur="consultValidAlterEmail();" tabindex="4" maxlength="60"/>
                                            <label class="labelStylereq" >Linkedin link:</label>
                                            <s:textfield cssClass="form-control" name="consult_linkedInId" id="consult_linkedInId" placeholder="Linked In link"  value="%{consultantVTO.consult_linkedInId}" tabindex="4" maxlength="120"/>
                                        </div>
                                        <div class="col-lg-4" >
                                            <label class="labelStylereq" >Available Date:</label>
                                            <s:textfield cssClass="form-control dateImage" name="consult_favail" value="%{consultantVTO.consult_favail}" id="consult_favail"   placeholder="" onkeypress="return consultantDateRepository(this)" tabindex="1"/>
                                            <span class="required">
                                            ...
                                            <s:textfield cssClass="form-control" name="consult_facebookId" id="consult_facebookId" value="%{consultantVTO.consult_facebookId}" placeholder="Facebook link"  tabindex="4" maxlength="120"/>
                                        </div>
                                        <div class="col-lg-4" >
                                            ...
                                            <s:textfield cssClass="form-control" name="consult_twitterId" id="consult_twitterId" value="%{consultantVTO.consult_twitterId}" placeholder="Twitter link"  tabindex="4" maxlength="120"/>
                                        </div>
                                        ...
                                        <s:if test="%{consultFlag=='vendor'}">
                                            ...
                                            <div class="" id="task-panel" style="margin-left:-13%">
                                                <div  class="col-lg-4 " >
                                                    ...
                                                    <s:select cssClass="form-control SelectBoxStyles" value="%{consultantVTO.consult_relocation}" name="consult_relocation" id="consult_relocation" headerKey="-1" headerValue="Select Relocation" list="{'Yes','No'}" onchange="handleSelect(this)" tabindex="9"/>
                                                ...
                                                <div class="col-lg-4">      
                                                    ...
                                                    <s:select cssClass="form-control SelectBoxStyles" value="%{consultantVTO.consult_preferredCountry}"   name="consult_preferredCountry" id="consult_preferredCountry"  headerKey="-1" headerValue="Select Country" list="country" onchange="AddConsultantEditPreferredStateChange()"  tabindex="1"/>
                                                ...
                                                <div class="col-lg-4">  
                                                    ...
                                                    <s:select cssClass="" value="%{consultantVTO.consult_preferredState}"  name="consult_preferredState" multiple="true" id="consult_preferredState"     headerKey="-1" headerValue="Select preferred state" list="preState" />
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <s:select cssClass="commentsStyle" name="skillCategoryValueList"  id="skillCategoryValue" list="skillValuesMap" multiple="true" onfocus="clearErrosMsgForGrouping()" value="%{consultantVTO.skillSetList}"/> 
                                        ...
                                        <s:else>
                                            <div class="col-lg-12 " >
                                                ...
                                                <div class="col-lg-2 ">
                                                    <s:submit type="button" cssStyle="margin:12px;" name="savetask" cssClass="cssbutton_save" onclick="return ConsultDetails_valid()"  value=""><i class="fa fa-plus-square"></i>&nbsp;Save</s:submit>
                                                    </div>
                                                </div>
                                        </s:else>
                    ...
                    <div class="tab-pane fade " id="consult_attach" onclick="getConsultantAttachments.action"   >
                        ...
                        <a href="" class="consultAttachment_popup_open" onclick="return attachPopJs();"><button id="cssbutton" class="pull-right">Add</button></a> <br> <br>
