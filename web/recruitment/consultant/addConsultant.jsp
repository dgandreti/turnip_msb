                                    ...
                                    <div class="col-lg-12 ">
                                        ...
                                        <s:form action="addConsultantDetails" id="consultantForm" theme="simple" method="POST" enctype="multipart/form-data" >
                                            ...
                                            <div class="col-sm-4 required">
                                                ...
                                                <s:select cssClass="form-control SelectBoxStyles" name="primarySkillValue" headerKey="-1" headerValue="Select Skill"  tabindex="30" id="primarySkillValue" list="reqCategory" value="%{requirementVTO.reqCategory}" onchange="AddConsultantSkillChange();"/> 
                                            </div>
                                            <div class="col-sm-7 required">
                                                <label  class="labelStylereq skills" style="margin:-0px;">Skills</label>
                                                <s:select cssClass="commentsStyle" name="skillCategoryValueList"  tabindex="30" id="skillCategoryValue" list="{}" multiple="true" onfocus="clearErrosMsgForGrouping()"/> 
                                        ...
                                        <div class="panel-body" id="task-panel"> 
                                            <div style="margin-left: -13%;">
                                                ...
                                                <div class="col-sm-4  " > 
                                                    ...
                                                    <s:select cssClass="form-control SelectBoxStyles"  name="consult_preferredRegion " id="consult_preferredRegion"  headerKey="-1" headerValue="Select Region" list="regionName" onchange="AddConsultantStateChange()" tabindex="5"/>
