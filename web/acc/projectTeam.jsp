                                        ...
                                        <div class="inner-reqdiv-elements">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">       
                                                    ...
                                                    <s:select id="status" name="status"  cssClass="form-control SelectBoxStyles" tabindex="2" headerKey="DF" list="#@java.util.LinkedHashMap@{'Active':'Active','In-Active':'In-Active'}"/>
                                                </div>
                                                <div class="col-sm-2 pull-right" style="margin-top: 18px" id="addTeamMemberButton">
                                                    <a href='acc/setTeamMembersForProject.action?projectID=<%=projectId%>&projectFlag=addMember' class="add_searchButton form-control" style="margin:5px" tabindex="4"><i class="fa fa-plus-square"></i>&nbsp;Add</a>  
                                                </div>
                                                <div class="col-sm-2 pull-right"style="margin-top: 18px">
                                                    <button type="button" class="add_searchButton form-control"  value="" onclick="return searchTeamMembers();" style="margin:5px" tabindex="3"><i class="fa fa-search">&nbsp;Search</i></button>
                                                </div>
