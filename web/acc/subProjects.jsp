    ...
    <div id="resourceOverlay" >
        ...
        <div class="overlayOrButton_color">
            <table>
                ...
                <span class=" pull-right"><h5><a href="" class="resourceOverlay_popup_close" onclick="showResourceTeamOverlayClose()"><i class="fa fa-times-circle-o fa-size"></i></a>&nbsp;</h5></span>
            </table>
        </div>
    ...
    <div id="addSubProjectOverlay" >
        ...
        <div class="backgroundcolor" >
            <table>
                ...
                <span class=" pull-right"><h5><a href="" class="addSubProject_popup_close" onclick="removeResults();"><i class="fa fa-times-circle-o fa-size"></i></a>&nbsp;</h5></span>
            </table>
        </div>
                ...
                <div>
                    ...
                    <div class="inner-addtaskdiv-elements">
                        ...
                        <div  class="inner-addtaskdiv-elements" style="text-align: right">
                            <s:reset cssClass="add_searchButton fa fa-eraser"  style="width:105px;height:30px;" type="button" value="Clear" theme="simple" onclick="resetOverlayForm();"/>
    ...
    <div id="subprojectSkillSetBox" class="marginTasks">
        <div class="backgroundcolor">
            <table>
                ...
                <span class="pull-right"> <h5 >&nbsp;&nbsp;&nbsp;&nbsp;<a href="" class="subprojectSkillOverlay_popup_close" onclick="subprojectSkillSetOverlayClose()" ><i class="fa fa-times-circle-o fa-size"></i></a></h5></span>
            </table>
        </div>
        <div>
    ...
    <div id="subprojectDescBox" class="marginTasks">
        <div class="backgroundcolor">
            <table>
                ...
                <span class="pull-right"> <h5 >&nbsp;&nbsp;&nbsp;&nbsp;<a href="" class="subprojectsDescOverlay_popup_close" onclick="subprojectDescriptionOverlayClose()" ><i class="fa fa-times-circle-o fa-size"></i></a></h5></span>
            </table>
        </div>
        <div>
                    ...
                    <div id="subProjectsForm">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="col-sm-12" style="margin-bottom: 5px">
                                ...
                                <s:submit type="button" cssClass="add_searchButton form-control" value="" onclick="searchSubProjects()" align="right" cssStyle="margin:5px" tabindex="6"><i class="fa fa-search"></i>&nbsp;Search</s:submit>
                                </div>
                                <div class="col-sm-2 pull-right contact_search" id="addSubPro">
                                    <a href="" class="addSubProject_popup_open" ><button class="add_searchButton form-control" style="margin:5px" onclick="clearSubprojectOverlay()" tabindex="5"><i class="fa fa-plus-square"></i>&nbsp;Add</button></a>
                                </div>
                            </div> 
                        </div>
                    </div>
                                ...
                                <table id="projectResults" class="responsive CSSTable_task" border="5"  >
                                    ...
                                    <s:iterator  value="searchDetails">
                                        ...
                                        <tr>
                                            ...
                                            <%--<td><s:a onclick="this.href='projectDetails.action?projectID='+%{projectID}+'&accountID='+%{accountID}+'&remainingTargetHrs='+document.getElementById('remainingTargetHrs').value"><s:property value="projectName"/></s:a></td>--%>
                                           <td><s:a href="" onclick="this.href='projectDetails.action?projectID='+%{projectID}+'&accountID='+%{accountID}+'&mainProjectStartDate='+document.getElementById('projectStartDate').value+'&mainProjectTargetDate='+document.getElementById('projectTargetDate').value+'&remainingTargetHrs='+document.getElementById('remainingTargetHrs').value"><s:property value="projectName"/></s:a></td>
