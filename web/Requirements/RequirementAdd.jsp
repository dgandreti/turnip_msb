                                                    ...
                                                    <table>
                                                        ...
                                                        <div class="col-sm-6 pull-right "> 
                                                            <div class="col-sm-2 contact_search pull-right">
                                                                <s:reset type="button" cssStyle="margin:5px 0px;" cssClass="add_searchButton  form-control fa fa-eraser" value="Clear" theme="simple"  onfocus="removeErrorMessages()" onclick="requirementClearValidation()"/> &nbsp;    
                                                            </div>
                                                            <div class="col-sm-2 contact_search pull-right">
