                            ...
                            <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                ...
                                <div class="inner-reqdiv-elements">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <s:select cssClass="SelectBoxStyles form-control" name="interviewType" id="interviewType" list="#@java.util.LinkedHashMap@{'Face to Face':'Face to Face','Telephonic':'Telephonic','Skype':'Skype','Written':'Written','hr':'hr','Online':'Online','Psychometric':'Psychometric'}" headerKey="-1" value="1" onchange="setLocationForFaceToFace();"/>
                                        </div>
                                        <s:hidden name="empIdTechReview" id="empIdTechReview" />
                                        <s:hidden name="empIdTechReview2" id="empIdTechReview2" />

                                        <div class="col-lg-3 required" id="reviewTech">
                                            <label class="labelStylereq" style="color: #56a5ec">Reviewer:</label>
                                            <s:textfield cssClass="form-control" id="eNameTechReview"  name="eNameTechReview" onkeyup="return getEmpForTechReview();" autocomplete='off' maxLength="30" onfocus="return removeErrorMsgForTechie();"/>
                                        </div>


                                        <div class="col-lg-3 " id="reviewSeverity" style="display: none">
                                        ...
                                        <div id="techDuration" style="display: none">
                                            ...
                                            <div class="col-lg-3 required" id="reviewQuestions" style="display: none">
                                        ...
                                        <div class="row required" style="display: none" id="techSkills">
                                            <div class="col-lg-12 skill_online required" id="">
                                        ...
                                        <div class="row required" style="display: none" id="psychoTestSkills" >
                                            <div class="col-lg-12 skill_online required" id="">
                                        ...
                                        <div class="col-lg-3 required" id="revewSkill0" style="display: none">
                                        ...
                                        <div class="col-lg-3 required" id="revewSkill1" style="display: none">
                                         ...
                                         <div class="col-lg-3 required" id="revewSkill2" style="display: none">
                                          ...
                                          <div class="col-lg-3 required" id="revewSkill3" style="display: none">
                                        ...
                                        <div class="col-lg-3 required" id="revewSkill4" style="display: none">
                                        ...
                                        <div class="col-lg-3 required" id="revewSkill5" style="display: none">
                                        ...
                                        <div class="col-lg-3 required" id="revewSkill6" style="display: none"> 
                                        ...
                                        <div class="col-lg-3 required" id="revewSkill7" style="display: none">
                                        ...
                                        <div class="col-lg-3 required" id="revewSkill8" style="display: none">
                                        ...
                                        <div class="col-lg-3 required" id="revewSkill9" style="display: none">
                                        ...
                                        <%-- </div>--%>
                                        <div class="col-lg-3 required" id="revewInterview">
                                            <label class="labelStylereq" style="color: #56a5ec">Interview Date:</label>
                                            <s:textfield cssClass="techReviewInputStyle dateImage" id="interviewDate"  name="interviewDate" onkeypress="return enterTechDateRepository(this);" onfocus="return removeErrorMsgForTechie();" />
                                        </div>
                                        <div class="col-lg-3" id="reviewZone">
                                ...
                                <div class="inner-reqdiv-elements">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 required" id="locationData" >
                                            <label class="labelStylereq" style="color: #56a5ec">Location:</label>
                                            <s:textarea cssClass="form-control" maxlength="200" name="interviewLocation" id="interviewLocation" onkeyup="checkCharactersComment(this)"  onfocus="return removeErrorMsgForTechie();"/>
                                        </div>


                                    </div>
                                    <div class="row">
                                        <div class="col-lg-12 " id="reviewComments" style="display: none">
                                ...
                                <div class="col-lg-2">
                                    <s:submit type="button" cssClass="add_searchButton form-control" cssStyle="margin:0px 0px;" value="" onclick="forwardReviewToCustomer();" theme="simple"><i class="fa fa-forward"></i>&nbsp;Forward</s:submit>
                                </div>
                                <%--</s:form>--%>
                            </div>
                        </div>
