                            ...
                            <div id="timesheetMisc_popup">
                                <div id="timesheetMisc_Overlay">
                                    ...
                                    <form action="#" theme="simple" >
                                        ...
                                        <div class="col-md-6">
                                            <button  type="button" style="margin: 5px 0px;"  class="add_searchButton form-control" value="" onclick="return miscellaneousData()">&nbsp;Go&nbsp;&nbsp;<i class="fa fa-arrow-circle-o-right"></i></button>&nbsp; 
                                        </div>
                                    </form>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="inner-addtaskdiv-elements">    
                                                    <div class="col-sm-12">
                                                        <div class=""> 
                                                            <div class="col-sm-7">
                                                                <div class="col-sm-12">  <div class="col-sm-6">    <label class="labelStyle-i add-to" id="labelLevelStatusReq" style="float: left">Total Billable Hrs</label></div>
                                                                    <div class="col-sm-6"> <s:textfield name="totalBillHrs" id="totalBillHrs" cssClass="form-control SmallTextBox_Time" readonly="true" value="0.0" tabindex="-1" style="float: left"/></div>
                                                                </div>
                                                                <div class="col-sm-12">  <div class="col-sm-6"><label class="labelStyle-i add-to" id="labelLevelStatusReq" style="float: left">Total Holiday Hrs</label></div>
                                                                    <div class="col-sm-6">  <s:textfield name="totalHolidayHrs" id="totalHolidayHrs" cssClass="form-control SmallTextBox_Time" readonly="true" value="0.0" tabindex="-1" style="float: left"/></div>
                                                                </div>
                                                                <div class="col-sm-12"><div class="col-sm-6"> <label class="labelStyle-i add-to" id="labelLevelStatusReq" style="float: left">Total Vacation Hrs</label></div>
                                                                    <div class="col-sm-6">    <s:textfield name="totalVacationHrs" id="totalVacationHrs" cssClass="form-control SmallTextBox_Time" readonly="true" value="0.0" tabindex="-1" style="float: left"/></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-5">
