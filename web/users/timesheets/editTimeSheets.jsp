                            ...
                            <div id="timesheetMisc_popup">
                                <div id="timesheetMisc_Overlay">
                                    ...
                                    <form action="#" theme="simple" >
                                        ...
                                        <div class="col-md-6">
                                            <button type="button" style="margin: 5px 0px;" class="add_searchButton form-control" value="Go" onclick="return miscellaneousData()">&nbsp;Go&nbsp;&nbsp;<i class="fa fa-arrow-right"></i></button> 
                                        </div>
                                    </form>
                                </div>
                            </div>
