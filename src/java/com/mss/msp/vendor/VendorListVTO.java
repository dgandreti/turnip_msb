...
public class VendorListVTO {
    ...
    public String getVendorIndustryName() {
        return vendorIndustryName;
    }

    public void setVendorIndustryName(String vendorIndustryName) {
        this.vendorIndustryName = vendorIndustryName;
    }
